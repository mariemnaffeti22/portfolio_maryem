    ...
    <nav class="mb-12 border-b-2 border-light-tail-100 dark:text-dark-navy-100">
        <ul class="flex flex-col lg:flex-row justify-evenly items-center">
            <li class="cursor-pointer capitalize m-4">
                ...
                class="flex text-center px-5 py-2 bg-light-tail-500 dark:bg-dark-navy-100 hover:bg-accent text-black rounded-md transition">All</button>
           </li>
         ...
         <li class="cursor-pointer capitalize m-4" x-data="{projectSkill: {{ json_encode($projectSkill) }}}">
                ...
                class="flex text-center px-4 py-2 bg-light-tail-500 dark:bg-dark-navy-100 hover:bg-accent text-black rounded-md">{{ $projectSkill->name}}</button>
           </li>
         @endforeach
        </ul>
    </nav>
