<header x-data="{ mobileNavOpen: false }">
    <nav x-data="navigation" x-effect="changeNavBg"
        ...
        <a href="https://flowbite.com/" class="flex items-center">
                <img src="img/logo.jpg" class="mr-3 h-6 sm:h-9" alt="Flowbite Logo">
                <span class="self-center text-xl font-semibold whitespace-nowrap dark:text-white">Mariem Naffeti</span>
            </a>
